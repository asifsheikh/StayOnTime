...
int id=0;
    ...
    private void initViews() {
        final SplashScreen app = new SplashScreen();
        ...
        txtName.setText("You logged in as the " +
                (id == SplashScreen.FIRST_USER_ID ? "1st user" : "2nd user"));
        ...
        startStopVideoCallBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(btn.getText().equals("Call user")){
                    ...
                    opponentUser.setId((id == SplashScreen.FIRST_USER_ID ? SplashScreen.SECOND_USER_ID : SplashScreen.FIRST_USER_ID));
